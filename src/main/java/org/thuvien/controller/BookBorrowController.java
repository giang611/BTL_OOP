...
public class BookBorrowController {
    ...
    public void saveBorrowRecord(ActionEvent event) {
        ...
        borrowRecord.setMember(member); // Gắn member vào borrowRecord
        ...
        ScreenController.switchScreen((Stage) bookNameLabel.getScene().getWindow(), "/home/mixBookLoan.fxml");
    }
    ...
    public void Back()
    {
        ScreenController.switchScreen((Stage) borrowDatePicker.getScene().getWindow(), "/home/mixBookLoan.fxml");
    }
}
